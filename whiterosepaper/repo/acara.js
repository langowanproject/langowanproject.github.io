    ...
    const acara = `
        <div class="card-wrap">
            ...
            <div class="card4">
                ...
                <div class="floral kanan-atas2 gerakkiri3">
                    <img class="flipboth" src="assets/white-rose.webp" alt="Daun Kanan Bawah" width="150px">
                </div>

                <div class="floral kiri-bawah2 gerakkanan3">
                    <img class="" src="assets/white-rose.webp" alt="Daun Kiri Bawah" width="150px">
                </div>
            </div>
            <div class="right">
            <div class="card5">
                ...
                <div class="floral kiri-atas2 gerakkanan3">
                    <img class="flipY" src="assets/white-rose.webp" alt="Daun Kanan Bawah" width="150px">
                </div>

                <div class="floral kanan-bawah2 gerakkiri3">
                    <img class="flip" src="assets/white-rose.webp" alt="Daun Kiri Bawah" width="150px">
                </div>
            </div>
        </div>
    `;

    ...
    const acara = `
        <div class="card-wrap">
            ...
            <!-- Daun di sudut kanan bawah -->
                <div class="floral kanan-bawah2 gerakkanan1">
                     <img class="flip" src="assets/floral2.webp" alt="Daun Kanan Bawah" width="200rem">
                </div>            
            </div>
            <div class="right">
            <div class="card5">
                ...
                <div class="floral kiri-bawah2 gerakkiri1">
                     <img class="" src="assets/floral2.webp" alt="Daun Kanan Bawah" width="200rem">
                </div>
            </div>
        </div>
    `;
